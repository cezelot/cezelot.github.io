...
const directories = {
    about: [
        ...
        '<white>Public key:</white>\t\t<a href="pubkey.txt">D0C9 E5B2 B133 EF2A 1A6B</a>',
        '',
        'I write code'
    ],
    projects: [
    ...
    links: [
        [
           ['sourcehut',
            ...
            return `<a href="${url}">${name}</a>\t<a href="${url2}">${name2}</a>`;
        }),
        [
           ['itch.io',
...
function ready() {
    ...
    term.echo(() => rainbow(render('cezelot'), seed))
        .echo('<white>Hi there, welcome to my little corner in the internet</white>\n').resume();
}
